...
@Component
public class MaxYearSpecificationProvider
        implements SpecificationProvider<Wine> {

    private static final String KEY = "maxYear";
    ...
    public Specification<Wine> getSpecification(String[] params) {
        throw new UnsupportedOperationException(
                "MaxPriceSpecificationProvider requires an integer parameter"
        );
    }
    ...
    public Specification<Wine> getSpecification(double param) {
        throw new UnsupportedOperationException(
                "MaxYearSpecificationProvider requires an integer parameter"
        );
    }
}
